...
cat("Key Security Features:\n")
cat("  ✓ Worker runs in isolated Docker container\n")
cat("  ✓ Container uses isolated bridge network with --internal flag\n")
cat("  ✓ No external network access (cannot reach internet)\n")
cat("  ✓ Only worker communication port is exposed to host\n")
cat("  ✓ Read-only filesystem with limited tmpfs\n")
cat("  ✓ Non-root user execution\n")
cat("  ✓ All capabilities dropped\n")
cat("  ✓ Memory and CPU limits enforced\n")
cat("  ✓ Automatic cleanup of containers and networks\n\n")

cat("Use Cases:\n")
cat("  • Running untrusted R code safely\n")
cat("  • Preventing data exfiltration\n")
cat("  • Sandboxed package testing\n")
cat("  • Security-sensitive computations\n")
cat("  • Multi-tenant R execution environments\n")
